export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    add_assets: IDL.Func([IDL.Opt(IDL.Nat64), IDL.Vec(NestedAssets)], [Result], []),
    add_chunks: IDL.Func([IDL.Vec(IDL.Tuple(IDL.Nat64, IDL.Vec(IDL.Nat8)))], [], []),
    change_asset_name: IDL.Func([IDL.Text, AssetWithId], [Result_1], []),
    change_asset_owner: IDL.Func([IDL.Principal, AssetWithId], [Result_1], []),
    change_asset_parent: IDL.Func([IDL.Opt(IDL.Nat64), AssetWithId], [Result_1], []),
    change_asset_permission: IDL.Func([Permission, AssetWithId], [Result_1], []),
    create_directory: IDL.Func([IDL.Text, Permission, IDL.Opt(IDL.Nat64)], [Result_2], []),
    delete_asset: IDL.Func([AssetWithId], [Result_3], []),
    get_assets_tree: IDL.Func([IDL.Opt(IDL.Nat64), IDL.Bool], [IDL.Vec(Asset)], ["query"]),
