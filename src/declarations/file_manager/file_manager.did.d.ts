...
export type Asset = { File: FileResponse } | { Directory: DirectoryResponse };
export type AssetWithId = { File: bigint } | { Directory: bigint };
...
export interface NestedAssets {
  asset: PostAsset;
  children: Vec_1;
}
export type Permission = { Private: null } | { Origin: Array<string> } | { Public: null };
export type PostAsset = { File: PostFile } | { None: null } | { Directory: PostDirectory };
...
export type Result = { Ok: Array<[FileResponse, string]> } | { Err: [Array<Asset>, string] };
export type Result_1 = { Ok: Asset } | { Err: string };
export type Result_2 = { Ok: DirectoryEntity } | { Err: string };
...
export type Vec = Array<
  | {
      File: {
        id: bigint;
        permission: { Private: null } | { Origin: Array<string> } | { Public: null };
        updated_at: bigint;
        sha256: Uint8Array | number[];
        owner: [] | [Principal];
        metadata: [] | [string];
...
export interface _SERVICE {
  ...
  add_chunks: ActorMethod<[Array<[bigint, Uint8Array | number[]]>], undefined>;
  ...
  create_directory: ActorMethod<[string, Permission, [] | [bigint]], Result_2>;
